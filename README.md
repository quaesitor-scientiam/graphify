...
- [ ] **remaining call-edge ambiguity.**
  ...
  Cheaper remaining win: emit `AMBIGUOUS`-tagged edges to *all* candidates instead of dropping them, so "find callers" degrades to a short list rather than silence.
